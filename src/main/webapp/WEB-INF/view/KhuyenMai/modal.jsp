...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="/mau-sac/action" method="post" id="frmAction">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" name="voucherCode" id="voucherCode" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <label for="minimumInvoice" class="form-label">Đơn tối thiểu</label>
                                <input class="form-control" name="minimumInvoice" id="minimumInvoice" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <label for="dateStart" class="form-label">Ngày bắt đầu</label>
                                <input class="form-control" type="dateStart" name="name" id="dateStart" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="voucherType" id="voucherType" aria-label="Default select example">
