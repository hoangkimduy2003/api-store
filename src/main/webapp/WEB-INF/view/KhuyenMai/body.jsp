...
<div class="container m-2">
    ...
    <button type="button" onclick="preAction(null,null,null,null,null,null,1,null,null,1,1,1)" style="width: 150px" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#exampleModal">
        Thêm khuyến mại
    </button>
        ...
        <table class="table">
            ...
            <c:forEach items="${list.data}" var="x" varStatus="loopStatus">
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-warning" onclick="preAction(${x.id},'${x.voucherCode}','${x.minimumInvoice}','${x.dateStart}','${x.dateEnd}','${x.quantity}','${x.voucherType}','${x.promotionalLevel}','${x.maximumPromotion}','${x.status}',2,${x.sendType})"
                                data-bs-toggle="modal" data-bs-target="#exampleModal">
                            Sửa
                        </button>
                        <button onclick="handleOnClickSendKhuyenMai('${x.id}',this)" style="${(x.sendType == 1 && x.status == 1)? "" : "display: none"}" class="btn btn-info"><i class="bi bi-envelope-arrow-up-fill"></i></button>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
